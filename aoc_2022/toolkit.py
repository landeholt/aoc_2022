...
def get(day, path: str = ""):
    ...
    return requests.get(f"https://adventofcode.com/{year}/day/{day}{path}", cookies=cookies).text

def post(day, data):
    from aoc_2022.env import cookies, year
    return requests.post(f"https://adventofcode.com/{year}/day/{day}/answer", cookies=cookies,data=data).text
